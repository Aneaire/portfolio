  ...
  return (
    <div className="mt-8 w-full max-w-5xl">
      <div className="relative">
        ...
        <div className="relative bg-background/50 backdrop-blur-sm rounded-lg p-6 border border-border/50">
